    ...
    return (
        ...
        <div className={menuState ? "absolute z-40 flex-col justify-between transition duration-150 ease-in-out bg-gray-800 shadow md:h-full sm:hidden" : "absolute z-40 flex-col justify-between transition duration-150 w-64 ease-in-out bg-gray-800 shadow md:h-full sm:hidden"} id="mobile-nav">
            ...
            <div className={menuState ? "hidden" : "px-8"} style={{height:"100vh"}}>
                ...
                <ul className="mt-12">
                    <Link href="/panel">
                        <li className={router.pathname === '/panel' ? "flex items-center justify-between w-full px-4 py-2 mb-6 font-bold text-gray-100 duration-100 ease-in cursor-pointer rounded-xl hover:bg-primaryColor bg-primaryColor" : "flex items-center justify-between w-full px-4 py-2 mb-6 font-bold text-gray-100 duration-100 ease-in cursor-pointer rounded-xl hover:bg-primaryColor"}>
                            <div className="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                                    <AiFillHome className="w-6 h-6"/>
                                    <span className="ml-2 text-sm">Početna</span> 
                            </div>
                        </li>
                    </Link>
                    <Link href="/panel/uredjaji">
                    ...
                    <Link href="/panel/prostorije">
                        <li className={router.pathname === '/panel/prostorije' ? "flex items-center justify-between w-full px-4 py-2 mb-6 font-bold text-gray-100 duration-100 ease-in cursor-pointer rounded-xl hover:bg-primaryColor bg-primaryColor" : "flex items-center justify-between w-full px-4 py-2 mb-6 font-bold text-gray-100 duration-100 ease-in cursor-pointer rounded-xl hover:bg-primaryColor"}>
                            <div className="flex items-center focus:outline-none focus:ring-2 focus:ring-white" >
                                    <MdBedroomChild className="w-6 h-6"/>
                                    <span className="ml-2 text-sm">Prostorije</span>
                            </div>
                        </li>
                    </Link>
                    <Link href="/panel/faq">
                        <li className={router.pathname === '/panel/faq' ? "flex items-center justify-between w-full px-4 py-2 mb-6 font-bold text-gray-100 duration-100 ease-in cursor-pointer rounded-xl hover:bg-primaryColor bg-primaryColor" : "flex items-center justify-between w-full px-4 py-2 mb-6 font-bold text-gray-100 duration-100 ease-in cursor-pointer rounded-xl hover:bg-primaryColor"}>
                            <div className="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                                    <FaQuestionCircle className="w-6 h-6"/>
                    ...
                    <Link href="/">
                        <li className={router.pathname === '/odjava' ? "flex items-center justify-between w-full px-4 py-2 mb-6 font-bold text-gray-100 duration-100 ease-in cursor-pointer rounded-xl hover:bg-primaryColor bg-primaryColor" : "flex items-center justify-between w-full px-4 py-2 mb-6 font-bold text-gray-100 duration-100 ease-in cursor-pointer rounded-xl hover:bg-primaryColor"}>
                            <div className="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                                    <ImExit className="w-6 h-6"/>
