      ...
      <div className="grid pt-8 text-left border-t border-gray-200 md:gap-16 dark:border-gray-700 md:grid-cols-2">
          <div>
              ...
              <div className="mb-10">
                  ...
                  <p className="text-gray-500 dark:text-gray-400">re aware of the importance of well qualified support, that is why we decided that support will only be provided by the authors that actually worked on this project.</p>
              ...
              <div className="mb-10">
                  ...
                  <p className="text-gray-500 dark:text-gray-400">You can use Windster for an unlimited amount of projects, whether s a personal website, a SaaS app, or a website for a client. As long as you dont build a product that will directly compete with Windster either as a UI kit, theme, or template, its fine.</p>
