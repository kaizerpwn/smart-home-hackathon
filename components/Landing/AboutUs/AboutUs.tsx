                ...
                <section className="pb-40 text-gray-600 body-font">
                    <div className="container flex flex-wrap px-5 py-24 mx-auto">
                        ...
                        <div className="w-full mt-6 overflow-hidden rounded-lg lg:w-1/2 sm:w-1/3 sm:mt-0">
                            <Image loader={imageLoader} className="object-cover object-center w-full h-full" alt="hero image smart home" src={`https://dummyimage.com/600x300`} width={600} height={300} />
                        </div>
                    </div>
                </section>
        )
