  ...
  return (
    ...
    <div className="absolute flex-col justify-between hidden w-64 bg-gray-800 shadow sm:relative md:h-full sm:flex" style={{height:"100vh"}}>
          <div className="px-8">
              ...
              <ul className="mt-12">
                  <Link href="/panel">
                    <li className="flex items-center justify-between w-full px-4 py-2 mb-3 text-gray-100 duration-100 ease-in cursor-pointer rounded-xl hover:bg-primaryColor bg-primaryColor">
                  ...
                  <Link href="/panel/uredjaji">
                    <li className="flex items-center justify-between w-full px-4 py-2 mb-3 text-gray-100 duration-100 ease-in cursor-pointer rounded-xl hover:bg-primaryColor">
                        <div className="flex items-center focus:outline-none focus:ring-2 focus:ring-white"> 
      ...
      <div className={menuState ? "absolute z-40 flex-col justify-between transition duration-150 ease-in-out bg-gray-800 shadow md:h-full sm:hidden" : "absolute z-40 flex-col justify-between transition duration-150 w-64 ease-in-out bg-gray-800 shadow md:h-full sm:hidden"} id="mobile-nav">
          ...
          <div className={menuState ? "hidden" : "px-8"} style={{height:"100vh"}}>
              ...
              <ul className="mt-12">
                  ...
                  <Link href="/panel/uredjaji">
                    <li className="flex items-center justify-between w-full px-4 py-2 mb-6 font-bold text-gray-100 duration-100 ease-in cursor-pointer rounded-xl hover:bg-primaryColor">
                        <div className="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                                <BsCameraReelsFill className="w-6 h-6"/>
